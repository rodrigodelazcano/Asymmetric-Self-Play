...
class AliceSimulationInterface(
    ...
    def make_xml(cls, simulation_params: PSType, mujoco_timestep: float):
        ...
        object_xmls = cls.make_objects_xml(xml, simulation_params)
        object_group_ids = [
            i
        ...
        for group_id, (obj_xml) in zip(
            object_group_ids, object_xmls
        ):
    ...
    def hide_target(self, hide_robot=False):
        ...
        return self._hide_geoms(
            hide_objects=False, hide_robot=hide_robot
        )
    ...
    def hide_objects(self, hide_robot=False):
        ...
        """
        return self._hide_geoms(
            hide_objects=True, hide_robot=hide_robot
        )

    def _hide_geoms(self, hide_objects=False, hide_robot=False):
        sim = self.mj_sim
