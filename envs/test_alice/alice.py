...
PSType = TypeVar("PSType", bound=AliceSimParameters)
...
class AliceSim(AliceSimulationInterface):
    """
...
class AliceEnv(
    RearrangeEnv[AliceEnvParameters, RearrangeEnvConstants, BlockRearrangeSim]
):
    OBJECT_COLORS = (
        (1, 0, 0, 1),
        (0, 1, 0, 1),
